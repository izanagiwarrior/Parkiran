          ...
          <div class="container">
            ...
            <center>
              ...
              <table>
                <tr>
                  <th colspan="2">
                    <h1 class="text-center">Hello!<br>Pilih Parkiran Sesukamu, enjoy your parking!!</h1>
                  </th>
                </tr>
                <tr>
                  <td></td>
                ...
                <tr>
                  <td>
                    <center> <a href="{{url('/login')}}" class="btn btn-primary btn-block" style="background-color: Transparent;border-radius: 10px; width:200px; color:black;">Log In</a>
                      <center>
                  </td>
                  <td>
                    <center> <a href="{{url('/register')}}" class="btn btn-primary btn-block" style="background-color: Transparent;border-radius: 10px; width:200px; color:black;">Register</a></center>
                  </td>
