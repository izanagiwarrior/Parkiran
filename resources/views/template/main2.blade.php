...
>JuPark</h1>
  ...
  left:1300px;
  top:4px;"class="nav-item dropdown">
  ...
  left:1450px;
  top:40px;
src="foto/admin.png" width="50px" alt=""> <span class="sr-only">(current)</span>Akun Saya</a>
 <ul class="dropdown-menu">
  ...
  left:1450px;
  top:40px;
"src="foto/guest.png" width="50px" alt=""> <span class="sr-only">(current)</span>Akun Saya</a>
 <ul class="dropdown-menu">
          <li><a href="{{url('/profile')}}">Profile</a></li>
          <li><a href="{{url('/keranjang')}}">Booking</a></li>
		  <li><a href="{{url('/lihat_bukti_teracc')}}">Konfirmasi</a></li>
