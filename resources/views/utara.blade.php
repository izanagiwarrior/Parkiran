...
<div class="container mt-5">
  <div class="row">
    <div class="col text-center">
      <h1>Pakriran Utara</h1>
      <h3 class="text-center" style="color:cadetblue">Parkiran Bandung Utara</h3>
      <br><br>
    </div>
  </div @php $res=DB::select("select * from parkiran where kategori like '%Utara%' and kategori like ?",["%$kategori%"]); $resarr=$res; @endphp <div class="container mt-5 mb-5">
