...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="home.php"><img src="logojog.png" alt=""></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="pakaian.php">Pakaian</a>
            <a class="dropdown-item" href="kerajinan.php">Kerajinan</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="interface.php">Tentang Kami</a>
      ...
      <form class="form-inline my-2 my-lg-0">
        <a class="nav-link" href="profile.php"><img src="foto/profile.png" alt=""> <span class="sr-only">(current)</span></a>
